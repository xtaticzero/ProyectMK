...
CREATE TABLE STOCK_MARY_KAY_BBDD.CAT_PROVEEDOR {
    id_proveedor INT NOT NULL AUTO_INCREMENT,
    nombre VARCHAR(60) NOT NULL,
    correo_electronico VARCHAR(60) NOT NULL,
    sitio web VARCHAR(200) NOT NULL,
...
ALTER TABLE STOCK_MARY_KAY_BBDD.PRODUCTO ADD CONSTRAINT fk_proveedor_id FOREIGN KEY (id_proveedor) REFERENCES STOCK_MARY_KAY_BBDD.CAT_PROVEEDOR(id_proveedor);
